...
// ConfigDoc.cpp : CConfigDoc クラスの実装
//
...
//縮小版のサポート
void CConfigDoc::OnDrawThumbnail(CDC& dc, LPRECT lprcBounds)
{
...
// 検索ハンドラーのサポート
void CConfigDoc::InitializeSearchContent()
{
...
void CConfigDoc::SetSearchContent(const CString& value)
{
	if (value.IsEmpty())
	{
